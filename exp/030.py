...
train2 = pd.read_csv('input/JigsawToxicComment/jigsaw_toxic_comment_toxic_score.csv')
train2 = train2[train2['y']>0.2].reset_index(drop=True)
print(train2.shape)
print(train2['y'].value_counts())
del train2

train = pd.read_csv('input/JigsawToxicComment/jigsaw_toxic_comment_toxic_score_weighted.csv')
if CFG.DEBUG:
