...
def train_fn(epoch, model, train_data_loader, valid_data_loader, device, optimizer, scheduler, min_loss):
    model.train()
    losses = AverageMeter()
    scores = MetricMeter()
...
for fold in range(5):
    ...
    for epoch in range(CFG.epochs):
        ...
        train_avg, train_loss, valid_avg, valid_loss, min_loss = train_fn(epoch, model, train_dataloader, valid_dataloader, device, optimizer, scheduler, min_loss)
