...
external_path = 'input/external/'

train = pd.read_csv(external_path+'jig2_no_jig4_dup_df.csv')
train = train.fillna(0)
train['severe_toxicity'] = train['severe_toxicity'] * 2
train['y'] = (train[['toxicity', 'severe_toxicity', 'obscene', 'sexual_explicit',
...
train2 = pd.read_csv(external_path+'jig1_no_jig4_dup_df.csv')
train2['severe_toxic'] = train2['severe_toxic'] * 2
train2['y'] = (train2[['toxic', 'severe_toxic', 'obscene', 'threat', 'insult', 'identity_hate']].sum(axis=1) ).astype(int)

print(train2.shape)

train = pd.concat([train, train2], 0).reset_index(drop=True)
