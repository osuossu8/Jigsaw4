...
train_1 = pd.read_csv('input/JigsawToxicComment/jigsaw_toxic_comment_toxic_score.csv')
train_2 = pd.read_csv('input/JigsawUnintendedBias/jigsaw_unintended_bias_toxic_score.csv')
